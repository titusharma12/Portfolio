...
import emailEditorImage from "../assets/EmailTemplate.png";
...
const projects = [
    {
    title: "AI-Powered Email Template Editor",
    category: "Web Application",
    description:
      "Built an AI-powered email template editor with drag-and-drop functionality, prompt-based template generation, Google OAuth authentication, Zustand state management, and real-time preview with HTML export.",
    image: emailEditorImage,
    Url: "https://email-template-editor-with-ai.vercel.app/",
    features: [
  ...
  },
  {
    ...
    category: "Web Application",
    description:
      "Developed full authentication system with registration, login, password recovery, JWT authentication, and email-based OTP verification using Nodemailer.",
    image: authentication,
    Url: "https://authentication-sytem-frontend.vercel.app/",
    features: [
  ...
  accent1: "rgb(59,130,246)",       // Tailwind blue-500
accent2: "rgba(59,130,246,0.25)"  // lighter semi-transparent version
  },
  {
    title: "Mi Store Clone",
    category: "E-Commerce Clone",
    description:
      "Developed e-commerce clone with component-based architecture, shopping cart functionality, dynamic routing, and state management for smooth user experience.",
    image: miClone,
    Url: "https://mi-clone-one.vercel.app/",
    features: [
    ...
    accent1: "rgb(239,68,68)",
    accent2: "rgba(239,68,68,0.25)"
  },
  {
    title: "ResultBull",
